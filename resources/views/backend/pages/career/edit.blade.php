                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" action="{{ route('admin.' . $page . '.update', $data->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="title">Skills {!! \App\Util\Util::htmlReq() !!}</label>
                                    <input type="text" name="skill" class="form-control" id="title"
                                        value="{{ $data->skill }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Synopsis</label>
                                    <textarea class="textarea" id="editor1"
                                        name="synopsis">{!! $data->synopsis !!}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <textarea class="textarea" id="editor2"
