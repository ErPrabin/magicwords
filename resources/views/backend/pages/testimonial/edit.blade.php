                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" action="{{ route('admin.' . $page . '.update', $data->id) }}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="designation">Designation {!! \App\Util\Util::htmlReq() !!}</label>
                                    <input type="text" class="form-control" name="designation"
                                        value="{{ $data->designation }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Description {!! \App\Util\Util::htmlReq() !!}</label>
                                    <textarea class="textarea" id="editor1" name="description"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sort" class="form-control" name="sort" value="{{ $data->sort }}"
                                        required>
                                </div>
                            </div>
                            <!-- /.card-body -->
